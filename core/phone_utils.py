...
# Simple mapping of country calling codes to ISO 3166-1 alpha-2 codes
...
CALLING_CODE_TO_COUNTRY = {
    ...
    "378": "SM", "380": "UA", "381": "RS", "382": "ME", "385": "HR", "386": "SI", "387": "BA",
    "389": "MK", "420": "CZ", "421": "SK", "423": "LI", "500": "FK", "501": "BZ", "502": "GT",
    "503": "SV", "504": "HN", "505": "NI", "506": "CR", "507": "PA", "509": "HT", "590": "GP",
...
def get_country_code(phone_number):
    """
    Extracts country code from a phone number string.
    Assumes phone number starts with calling code.
    """
    cleaned = re.sub(r'\D', '', phone_number)
    # Check for 3-digit codes first, then 2, then 1
    for length in [3, 2, 1]:
